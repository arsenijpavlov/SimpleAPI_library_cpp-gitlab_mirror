...
- `программа-программа`: простая, с точки зрения программиста, упаковка значений в строку конфига, её передача до другого компьютера через сокет и простая распаковка в соотвествующие значения на другом компьютере
