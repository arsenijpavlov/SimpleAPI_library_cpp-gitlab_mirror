...
/* TODO: может имеет смысл сделать класс CommentDesign частью структуры WriterStile?
 *  в таком случае, придётся все такого рода обобщённые конфиги сделать через указатели для экономии места?
 */
