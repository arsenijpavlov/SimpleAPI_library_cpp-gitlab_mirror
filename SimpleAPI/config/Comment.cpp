...
//NOTE: при парсинге многострочных комментариев с окантовкой надо учитывать совпадение по закрывающей части
/*NOTE: должен ли быть пробел между знаками начала/конца м.комментария и окантовкой?
