...
public:
    ...
    // TODO: нужен конструктор, который принимает список других XML-документов
    // TODO: нужен конструктор, который принимает список других XML-документов
    ~ElementXml() noexcept {}
...
//    void    delete_suffix_comment(const size_t& index)                                  override;
    ...
    // Setters =========================================================================================================
private:
    void    init()                                                      noexcept                    { m_type = ValueType::eXml; }
public:
...
//    void    clearContainer()                                            noexcept        override    { m_values.clear(); }
    // ========================================================================================================== Modify
